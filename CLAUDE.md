...
- Always keep docs/CHANGELOG.md up to date with any changes or decisions made.
- Always keep OpenAPI schema up to date with any API changes.
- Always use the feature-dev skill when developing new features.
